                            ...
                            <div className="tab_content">
                                ...
                                <div id="tab1" className="tabs_item">
                                    <div className="features-overview">
                                        ...
                                        <div className="overview-image">
                                            <div className="image">
                                                <img src={require("../../images/features-image/back.jpg")} alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="tab2" className="tabs_item">
                                    <div className="features-overview">
                                        <div className="overview-image">
                                            <div className="image">
                                                <img src={require("../../images/features-image/prod-feature.jpg")} alt="image" />
                                            </div>
                                        </div>
                                ...
                                <div id="tab3" className="tabs_item">
                                    <div className="features-overview">
                                        ...
                                        <div className="overview-image">
                                            <div className="image">
                                                <img src={require("../../images/features-image/dm-feature.jpg")} alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="tab4" className="tabs_item">
                                    <div className="features-overview">
                                        <div className="overview-image">
                                            <div className="image">
                                                <img src={require("../../images/features-image/brand-feature.jpg")} alt="image" />
                                            </div>
                                        </div>
                                ...
                                <div id="tab5" className="tabs_item">
                                    <div className="features-overview">
                                        ...
                                        <div className="overview-image">
                                            <div className="image">
                                                <img src={require("../../images/features-image/dev-feature.jpg")} alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="tab6" className="tabs_item">
                                    <div className="features-overview">
                                        <div className="overview-image">
                                            <div className="image">
                                                <img src={require("../../images/features-image/marketing-feature.jpg")} alt="image" />
                                            </div>
                                        </div>
...
Accelerate Lead Conversion With CRMCity’s Marketing Automation Functionality
                                                ...
                                                <ul className="features-list">
                                                    <li><span><i className="flaticon-tick"></i>  Campaigns</span></li>
                                                    <li><span><i className="flaticon-tick"></i> Mailing Lists</span></li>
                                                    <li><span><i className="flaticon-tick"></i> Budgets and Expenses</span></li>
                                                    <li><span><i className="flaticon-tick"></i>  Email and SMS Marketing</span></li>
                                                    <li><span><i className="flaticon-tick"></i> Reporting and Analytics</span></li>
                                                    <li><span><i className="flaticon-tick"></i> Workflow Automation</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
