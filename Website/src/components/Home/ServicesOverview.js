                ...
                <div className="container">
                    <div className="overview-box it-overview">
                        ...
                        <div className="overview-image">
                            <div className="image">
                                <img src={require("../../images/services/it-service1.jpg")} alt="image" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="overview-box it-overview">
                        <div className="overview-image">
                            <div className="image">
                                <img src={require("../../images/services/it-service2.png")} alt="image" />
                            </div>
                        </div>
                    ...
                    <div className="overview-box it-overview">
                        ...
                        <div className="overview-image">
                            <div className="image">
                                <img src={require("../../images/services/it-service3.jpg")} alt="image" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="overview-box">
                        <div className="overview-image">
                            <div className="image">
                                <img src={require("../../images/services/it-service4.png")} alt="image" />
                            </div>
                        </div>
